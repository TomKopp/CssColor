 ...
 * @returns {number[]} Array of channels in bytes
 */
 ...
 * @param {boolean} [options.CSSColorsLevel3] Use CSS Colors Level 3 functional notation (old one)
 * @param {boolean} [options.percent] Use percentage values
 * @returns {string} The rgb value of the color in the form of `rgb(r g b[ / a])`; `rgb[a](r, g, b[, a])` if CSS Colors Level 3
 */
