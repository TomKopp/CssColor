...
import { uByte2hex } from '@witzbould/utils-u-byte2hex';
 ...
 */
export const rgb2hex = (red, green, blue, alpha) => `#${uByte2hexTwoDigit(red)}${uByte2hexTwoDigit(green)}${uByte2hexTwoDigit(blue)}${alpha ? uByte2hexTwoDigit(mapValueRange(alpha, 0, 1, 0, 255)) : ''}`;
